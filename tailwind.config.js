...
module.exports = {
  content: [
    "./src/**/*.{html,ts}",  // Your project files where Tailwind CSS should be applied
    "./src/app/shared/navbar/navbar.component.css" // Ensure your custom CSS files are included
  ],
  darkMode: 'class',
  theme: {
    fontFamily: {
    ...
    extend: {
      backdropFilter: {
        'glassy': 'blur(10px) saturate(150%)'
      },

      // Add a new background color with the glassy effect
      backgroundColor: {
        'glassy': 'rgba(255, 255, 255, 0.2)', // Adjust opacity as needed
        'glassy-dark': 'rgba(20, 25, 41, 0.6)', // Dark mode variant
      },
      colors: {
        'blue-zodiac': {
          '50': '#edf8ff',
